    ...
    <main class="page-wrapper mt-40">
        ...
        <article class="content-island reveal pt-60">
            ...
            <header class="island-section text-center max-w-900 mx-auto mb-40">
                ...
                <h1 class="section-title mb-25 text-fluid-h1 leading-tight">
            ...
            <div class="island-section">
                <img src="https://images.unsplash.com/photo-1434030216411-0b793f4b4173?auto=format&fit=crop&w=1200&q=80" alt="Material de estudio neuroeducativo sobre un escritorio de madera" class="article-hero-img">
            </div>
            ...
            <div class="island-section article-body mx-auto max-w-800">
                ...
                <div class="article-promo-box promo-orange">
                    <h3 class="article-promo-title text-orange text-22">¿Cansado de ser el "policía de los deberes"?</h3>
                    <p class="article-promo-text text-navy mx-auto max-w-600 mb-25">En Centro Futura enseñamos estas herramientas (y muchas más) a tu hijo/a para que adquiera una autonomía real. No hacemos los deberes por ellos, les enseñamos a estudiar.</p>
                    <a href="../contacto.php" class="btn-primary">Solicitar valoración de técnicas de estudio</a>
                </div>
                ...
                <div class="author-box">
                    ...
                    <div>
                        <h4 class="author-name font-900">Elena Martínez</h4>
                        <p class="author-role text-purple font-800">Directora Clínica y Pedagoga Colegiada</p>
                        <p class="author-bio text-15">Especialista en neuropsicología educativa, evaluación clínica de TDAH e intervención en funciones ejecutivas. Fundadora de Centro Futura en Rivas Vaciamadrid.</p>
                    </div>
                </div>
            ...
            <div class="related-articles-grid text-left">
                ...
                <article class="feature-card related-article-card">
                    ...
                    <div>
                        ...
                        <h3 class="related-article-title font-900">Dislexia: El texto no tiene que ser el enemigo de tu hijo</h3>
                    </div>
                ...
                <article class="feature-card related-article-card">
                    ...
                    <div>
                        ...
                        <h3 class="related-article-title font-900">Transición a la ESO: Cómo evitar que pierdan el rumbo</h3>
                    </div>
                    <a href="#" class="link-orange mt-10 mt-auto">Leer artículo →</a>
                </article>
